...
01/07/24 - So the issue is that I now have two different websites for coinbase and for kraken and for bitstamp because of SOL and XLM. So now I have to update my code to parse for the differences. Thats the next step. I got this!