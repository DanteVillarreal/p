...
03/21/24 - just saw that the network had q values that didnt make sense like the q value with the highest reward, aka 0, having -30 for its value. will decrease learning rate to 0.00001 most likely. I need to think about this more and look at the other c-dqn paper to see what they did. Im surprised its divergin though. it shouldnt be diverging. Maybe it only converges with a low learning rate?            JESUS IS GOOD. With his strength, we got this!